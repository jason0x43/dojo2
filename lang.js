        ...
        if (source && typeof source === 'object') {
            ...
            for (var name in source) {
                ...
                if (targetValue !== sourceValue) {
                    if (sourceValue && typeof sourceValue === 'object' && !(sourceValue instanceof RegExp) && !(sourceValue instanceof Number) && !(sourceValue instanceof Boolean) && !(sourceValue instanceof Date)) {
